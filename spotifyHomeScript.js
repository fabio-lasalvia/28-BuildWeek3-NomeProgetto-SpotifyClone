...
function popolaHero(song) {
  imgHero.src = song.album.cover_xl;
  ...
  //Reset di eventuali vecchi listener per evitare duplicazioni
  const nuovoHero = heroSection.cloneNode(true);
  heroSection.parentNode.replaceChild(nuovoHero, heroSection);

  nuovoHero.addEventListener("click", () => {
